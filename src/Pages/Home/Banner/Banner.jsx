...
const Banner = () => {
    return (
        <div>
            <Container>
                <div className="hero object-cover h-[600px]" style={{ backgroundImage: 'url(https://i.ibb.co/wd8nfk3/cafe-frankfurt-germany.jpg)' }}>
                    <div className="hero-overlay bg-opacity-70"></div>
                    <div className="hero-content text-center text-white">
                        <div className="max-w-md">
                            <h1 className="mb-5 text-5xl font-bold">Open a Book <br /> Open Your Mind</h1>
